package com.bangkit.capstone_project.tflite
...
class DeseaseClassifier(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    private fun getSortedResult(labelProbArray: Array<FloatArray>): List<Recognition> {
        ...
        Log.d("TfModel", "pqsize:(%d)".format(pq.size))
