...
fun WeatherCards(modifier:Modifier = Modifier) {
    Card(onClick = { /*TODO*/ }, modifier = modifier, colors = CardDefaults.cardColors(containerColor = Color.White), elevation =CardDefaults.cardElevation(defaultElevation = 4.dp) ) {
